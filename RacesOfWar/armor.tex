%\newcommand{\skillarmor}[7]{\noindent \textbf{#1} #2 \begin{small} \begin{quote}\textbf{#3}\\\textbf{4:} #4\\\textbf{8:} #5\\\textbf{13:} #6\\\textbf{18:} #7\end{quote}\end{small}}
%\newcommand{\attackarmor}[7]{\noindent \textbf{#1} #2 \begin{small}\begin{quote}  \textbf{#3}\\\textbf{+1:} #4\\\textbf{+5:} #5\\\textbf{+10:} #6\\\textbf{+15:} #7\end{quote}\end{small}}

%\newcommand{\skillarmor}[7]{\parbox{3.2in}{\noindent \textbf{#1} #2 \\ \small  \hspace*{0.2in}\parbox{3in}{\textbf{#3} \\ \textbf{4:} #4\\\indent\textbf{8:} #5\\\indent\textbf{13:} #6\\\indent\textbf{18:} #7\\}}}
%\newcommand{\attackarmor}[7]{\parbox{3.2in}{\noindent \textbf{#1} #2 \\ \small  \hspace*{0.2in}\parbox{3in}{\textbf{#3} \\ \textbf{+1:} #4\\\indent\textbf{+5:} #5\\\indent\textbf{+10:} #6\\\indent\textbf{+15:} #7\\}}}

%\newcommand{\skillarmor}[7]{{\noindent \textbf{#1} #2 \\ \small  \hspace*{0.2in}\parbox{3in}{\textbf{#3} \\ \textbf{4:} #4\\\indent\textbf{8:} #5\\\indent\textbf{13:} #6\\\indent\textbf{18:} #7\\}}}
%\newcommand{\attackarmor}[7]{{\noindent \textbf{#1} #2 \\ \small  \hspace*{0.2in}\parbox{3in}{\textbf{#3} \\ \textbf{+1:} #4\\\indent\textbf{+5:} #5\\\indent\textbf{+10:} #6\\\indent\textbf{+15:} #7\\}}}

%\newcommand{\skillarmor}[7]{\small \noindent\begin{tabular}{p{0.15in}p{2.7in}}\multicolumn{2}{l}{\textbf{#1}}\\  \multicolumn{2}{l}{\parbox{3in}{\footnotesize #2}}\\ \multicolumn{2}{l}{\footnotesize \textbf{#3}}\\ \raggedleft\textbf{\footnotesize 4:} & {\footnotesize #4}\\ \raggedleft\textbf{\footnotesize 8:} & {\footnotesize #5}\\ \raggedleft\textbf{\footnotesize 13:} & {\footnotesize #6}\\ \raggedleft\textbf{\footnotesize 18:} &{\footnotesize #7}\end{tabular}}
%\newcommand{\attackarmor}[7]{\small \noindent\begin{tabular}{p{0.15in}p{2.7in}}\multicolumn{2}{l}{\textbf{#1}}\\ \multicolumn{2}{l}{\parbox{3in}{\footnotesize #2}}\\ \multicolumn{2}{l}{\footnotesize \textbf{#3}}\\ \raggedleft\textbf{\footnotesize +1:} & {\footnotesize #4}\\ \raggedleft\textbf{\footnotesize +5:} & {\footnotesize #5}\\ \raggedleft\textbf{\footnotesize +10:} & {\footnotesize #6}\\ \raggedleft\textbf{\footnotesize +15:} &{\footnotesize #7}\end{tabular}}
...
\noindent \begin{tabular}{|lrrrr|}\hline
\parbox[c][12pt]{1pt}{}\textbf{Medium Armors}&AC&Max Dex&ACP&ASP\\\hline
\parbox[c][12pt]{1pt}{}Dragonscale&+6&+5&$-4$&$-2$\\
Gowns&+1&+3&$-5$&$-8$\\
Gith Armor&+5&+4&$-1$&$-5$\\
Hide Armor&+3&+4&$-4$&$-4$\\
Lamellar&+4&+4&$-4$&$-4$\\
Lobster Mail&+5&+2&$-5$&$-3$\\
Mithril Suit&+6&+5&$-2$&$-1$\\
Rime Hauberk&+5&+3&$-5$&$-3$\\
Ringmail&+4&+4&$-2$&$-3$\\
Scale Mail&+4&+3&$-5$&$-2$\\\hline
\parbox[c][12pt]{1pt}{}\textbf{Heavy Armors}&AC&Max Dex&ACP&ASP\\\hline
\parbox[c][12pt]{1pt}{}Adamantine&+11&+2&$-9$&$-4$\\
Coral Armor&+5&+2&$-3$&$-6$\\
Demon Armor&+9&+5&$-10$&$-3$\\
Elukian Clay&+6&+3&$-4$&$-5$\\
Dragonscale&+9&+4&$-5$&$-2$\\
Full Plate&+8&+1&$-6$&$-6$\\
Great Armor&+7&+2&$-7$&$-5$\\
Half Plate&+7&+2&$-5$&$-7$\\
Hoplite Armor&+6&+1&$-9$&$-5$\\
Mechanus&+12&+0&$-8$&$-8$\\
Silk Steel&+7&+3&$-4$&$-1$\\
Stone Plate&+10&+0&$-9$&$-11$\\
Sun Plate&+9&+6&$-10$&$-8$\\\hline
%&&&&\\\hline
\end{tabular}
\end{small}
\end{multicols}
