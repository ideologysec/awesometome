...
First, name your fighting style (such as "Hammer and Anvil Technique" or "Crescent Moon Style," or "Way of the Lightning Mace"). This fighting style only works with a small list of melee weapons that you have to describe the connectedness of to the DM in a half-way believable way. Now, whenever you are using that technique in melee combat, you gain a +2 bonus on attack rolls.}{
...
As a standard action, you can make a weapon attack that also reduces a creature's movement rate. For every 5 points of damage this attack does, reduce the creature's movement by 5'. These penalties last until the damage is healed.}{
