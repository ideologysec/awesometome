...
\ability{Effects:}{All Necromancy effects are at a +4 caster level, and every day spent in the city inflicts a negative level (this heals undead of 5 HP per day instead).}
...
\ability{Effects:}{The weather in the area is always at least as hot as "Severe Heat". Unearthly and burning heat happen wiht surprising regularity.}
...
\ability{Prerequisites:}{Such a city is never ruled by a magocracy or race with racial spell-like or supernatural abilities, and never sells magic items in its shops or markets.}
