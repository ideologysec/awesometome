...
\label{sphere:exorcism}\featname{Exorcism}
...
\label{sphere:mystery}\featname{Mystery}
...
\label{sphere:piety}\featname{Piety}
...
\label{sphere:restraint}\featname{Restraint}
...
\label{sphere:revelation}\featname{Revelation}
...
\label{sphere:splendor}\featname{Splendor}
...
\label{sphere:vigor}\featname{Vigor}
