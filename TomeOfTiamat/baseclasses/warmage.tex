\classname{Warmage}
\vspace{-8pt}
\quot{``Darkness beyond twilight, crimson beyond blood that flows...''}
...
\ability{Class Skills:}{Bluff (Cha), Concentration (Con), Knowledge (any) (Int), Sense Motive (Wis), Spellcraft (Int), Survival (Wis)}
