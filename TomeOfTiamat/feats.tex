...
\desc{A feat with the [Elemental] tag can only be taken by a creature who is from an inner plane or any Elemental or Outsider with an elemental subtype. The abilities granted by feats with the [Elemental] tag are Extraordinary abilities unless otherwise stated. If the feat has another similar tag (such as [Fiend], [Celestial], or [Fey]), a creature who fulfills the criteria for the other tag may waive this requirement; also, a creature who meets this requirement may waive the requirements of those other tags.}
...
\noindent{As the [ Fiend ] feat of the same name, except where noted below.}
