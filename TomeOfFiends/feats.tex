\subsection{[Fiend] Feats} \label{feats:fiend}
...
\descfeat{Attune Sphere}{You incorporate the workings of a fiendish sphere into your magic.}
\shortability{Prerequisite:}{Caster level 1+, Must have bled from a wound inflicted by a fiend with access to the chosen sphere.}
...
\descfeat{Extra Summons}
{You may use your Fiend Summoning ability two extra times each day}
\shortability{Prerequisite:}{Must have the signature \spell{summon} ability of the great Fiendish Houses.}
\shortability{Benefit:}{Your \spell{summon} ability may be used two extra times each day (the ability is normally usable once each day, so it could be used for 3 separate chances to conjure a fiend.)}
...
\descfeat{Greater Teleport [Monstrous]}
...
\descfeat{Heighten Spell-like Ability}
