...
%\begin{table}[tbh]
%\begin{small}\noindent\begin{tabular}{|p{3.3in}|p{3.3in}|}\hline
%\parbox[c][12pt]{1pt}{}\textbf{Physical Traits} & \textbf{Mental Traits}\\ \hline
%\parbox[c][12pt]{1pt}{}Drips slime or excessive dust wherever he goes&Cruel smile or laugh.\\
%A pair of appendages are of different color from the rest of body.&Distaste for the company of good-aligned people\\
%Scales, fur, or loose/cracking skin cover arms, legs, chest, back, or face (no game effect)&Fondness for disturbing imagery.\\
%Has a stylized wound that never heals&Seems pained or ill in good-aligned temples.\\
%Gains non-functional horns, spurs, or bone ridges&Must taste the blood on his weapons after every kill.\\
%Small hump on back&Displays no emotion at atrocity or other's pain.\\
%Body is feverishly hot or cold&Obviously enjoys the taste of bloody meat.\\
%Drools incessantly&Eat bugs when you think no one is watching.\\
%Breathe steams in any ambient temperature&Only laughs when seeing others in pain.\\
%Extra joint in fingers and toes.&Must keep an unholy symbol in your possession, if possible.\\
%Sharpened teeth (enlarged canines, shark teeth, or some other style)&Appears extremely avaricious in the presence of exposed wealth.\\
%Alien eyes(change in color, shape, or composition)&Becomes visibly excited when pain is inflicted on others.\\
%Extra non-functional eye or eyes on face.&Seems in awe of more powerful demons.\\
%Altered body proportions(longer or shorts arms, legs torso, etc) or size(large head, fist, etc).&Must lie about one's past, but only about unimportant details.\\
%Apparently dying of a disease(choose a disease, but it has no game effect)&Always asks to keep evil magic items or spellbooks with Corrupt or [evil] spells (can change mind as soon as one round later)\\
%Limb is rotted and skeletal (no game effect).&Bathes as little as possible.\\
%Limbs have extra tendons.&Must keep lair and possessions as clean as possible.\\
%Gain non-functional wings.&Seems angry and resentful with given a command.\\
%Hands resembles spiders.&Seems gloating and sarcastic when giving orders.\\
%Smells of ash or brimstone.&Seems fearful and guilty in the presence of celestials.\\
%Hole all the way through body in the center of torso.&Seems bored when morality is discussed.\\
%Stand unnaturally still when not paying attention.&Seems happy during funerals and executions.\\
%Cloven feet.&Leers at any woman of child-bearing age or older.\\
%Tentacles for fingers&When confront by authority figures, always seems bitter.\\
%Appears as if worms or bugs are crawling under skin.&Seems angry when charity or help is offered.\\
%Plants droop when held.&Seems to not understand respect for the dead.\\
%Extra ribs extend to pelvis&Is rude when asked for help or charity.\\
%Skin wrinkles when struck, and must be smoothed down.&Unable to show love.\\
%When sleeping, runes and glyphs press up from under skin.&Unable to express appreciation.\\
%Holy symbols and holy water cause very mild burns(no game effect)&\\\hline
