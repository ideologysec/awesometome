...
\noindent{The sad fact of the matter is that in the D\&D rules, there are really only 3 kinds of armor most people ever care about: Chain Shirt, Breast Plate, Full Plate. That's not only dumb, it's also a shame, because the D\&D world is potentially full of all kinds of crazy armor that is both awesome to look at and totally flavorful for all kinds of characters.}
...
}{Your armour is so shifty that you negate an amount of damage from any critical hit or sneak attack equal to your BAB.
}{You are surrounded by a 10ft radius area of Raw Limbo. You automatically succeed on unopposed control checks over this area, and gain a +4 bonus to opposed control checks. The controlled area reverts to normal once it leaves the affected radius.
}
