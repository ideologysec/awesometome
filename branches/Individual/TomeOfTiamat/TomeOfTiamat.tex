...
\newcommand{\featname}[2]{\vspace*{0.1cm plus 0.2cm minus 0.05cm}\noindent\textbf{#1}

#2}
\newcommand{\featnamelist}[1]{\vspace*{0.1cm plus 0.2cm minus 0.05cm}\noindent\textbf{#1}}

\newcommand{\descfeat}[3]{\featname{#1}
...
Any Sphere with unlisted portions (such as its granted ability or spell list) uses the Fiendish Sphere of the same name.
...
\input{baseclasses/elementalbrute}

\input{baseclasses/elementalweird}
