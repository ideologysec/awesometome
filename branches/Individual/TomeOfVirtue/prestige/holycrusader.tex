...
\itemability{Special:}{Must have [i]started[/i] a fight with an Evil Outsider. Angelic Knights need only meet one of the two skill requirements (but still must be Good and have the Blitz feat).}
\end{list}\vspace*{8pt}

\ability{Hit Die:}{1d10}
...
\ability{Aura of Menace}{The Holy Crusader gains an Aura of Menace, as per the Archon.}
