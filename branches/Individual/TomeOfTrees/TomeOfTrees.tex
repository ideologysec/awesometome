...
\chapter{Nature, Biology, Plants}

\chapter{Food, Disease, and Resources}

\chapter{Nature with Class}

\input{baseclasses/bard}
\input{baseclasses/ranger}
%\input{baseclasses/druid}

\section{Bonus Core Classes}

\input{baseclasses/spiritshaman}
\input{baseclasses/witch}

\chapter{Nature with Prestige}
...
\input{prestige/monsterrider}
\input{prestige/tigermonk}

\chapter{Feats and Spells}

\section{Feats}

\section{Spells}

\chapter{Enchantment in D\&D}

\chapter{Fey}

\section{Blood Flows Like Sap: Playable Races}

\input{feyraces}

\section{Faerie Spheres}
...
\chapter{Plant Monsters}

\chapter{Wilderness Adventure}
