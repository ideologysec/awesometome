...
\ability{Gather the Blood Honey:}{\desc{At 3rd level, the Lurker in the Swarm gains the ability to produce the notorious Blood Honey. Composed of the necromantically extracted essence of dying sentients and produced by undead bees, this blood red honey has the ability to heal wounds and restore vigor. When consumed, each dose of Blood Honey has the effects of a restoration and a regenerate spell.}

\noindent{Blood Honey is created when the Lurker's swarms kill a creature with at least 5 HD and an Int of 5 or better and then spends one hour in an obsidian hive. Only one dose can be produced each day by any one swarm.}}
