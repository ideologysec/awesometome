...
Miniatures are on the 30mm scale—a miniature figure of a six\textendash foot\textendash tall human is approximately 30mm tall. A square on the battle grid is 1 inch across, representing a 5\textendash foot\textendash by\textendash5\textendash foot area.
...
\ability{Reduced Speed:}Being encumbered up to a medium or heavy load or wearing medium or heavy armor reduces your speed.  The table below gives the reduced speeds for different base land speeds. \columnbreak

%This is not the original table from the SRD, but instead a better one partly lifted out of the Rules Compendium
\begin{tabular}[c]{c|c}
\multicolumn{2}{c}{\textbf{Table: Reduced Speed}} \\
...
\multicolumn{3}{c}{\textbf{Table: Creature Size and Scale}} \\
...
\subsection{Favorable and Ufavorable Conditions}
...
\begin{tabular}{l|cc}
\multicolumn{3}{c}{\textbf{Table: Common Armor, Weapon, and Shield Hardness and Hit Points}} \\
...
\multicolumn{3}{p{6.5in}}{\textsuperscript{1} The hp value given is for Medium armor, weapons, and shields. Divide by 2 for each size category of the item smaller than Medium, or multiply it by 2 for each size category larger than Medium.} \\
\multicolumn{3}{p{6.5in}}{\textsuperscript{2} Varies by material.} \\
\end{tabular}

\hypertarget{combat:splashweapon}
...
\begin{tabular}{c|c}
\multicolumn{1}{c}{\textbf{Table: Turning Undead}} \\
...
B
eginning at 4th level, paladins can turn undead as if they were clerics of three levels lower than they actually are.
