...
\newcommand{\magicfeat}[7]{
	\noindent\minitabular{\multicolumn{2}{l}{\parbox{3in}{\textbf{#1}}}}
	\minitabular{\multicolumn{2}{l}{\parbox{3in}{\small #2}}}
	\minitabular{\raggedleft\textbf{\small \textbf{0:}}& {\small #3}}
	\minitabular{\raggedleft\textbf{\small 1:} & {\small #4}}
	\minitabular{\raggedleft\textbf{\small 3:} & {\small #5}}
	\minitabular{\raggedleft\textbf{\small 6:} & {\small #6}}
	\minitabular{\raggedleft\textbf{\small 9:} &{\small #7}}
}
...
\newcommand{\metafeat}[2]{
  \noindent{\featname{#1}}
  \noindent{\textbf{Benefit:}{#2}}
}
...
\input{baseclasses/shadowwarrior}
%\input{baseclasses/pending/snowscaper}
\input{baseclasses/sohei}
\input{baseclasses/summoner}
\input{baseclasses/thiefacrobat}
\input{baseclasses/pending/thaumaturge}
\input{baseclasses/spherelock}
%\input{baseclasses/pending/warmage}
