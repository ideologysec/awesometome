...
The point is that this can cause very real arguments between people if they aren't on the same page. Like most other aspects of role playing gaming, you should hammer out exactly what your group is doing before you start playing.
...
The breakdown of characters with class levels and their levels in society at large in the DMG is almost exactly wrong in every respect. Think about it: when you think of the powerful people in your game world, how many of them are Wizards? Now, how many of them are Fighters? The truth is, everyone who is 15th level is actually of roughly equal power and capable of influencing the world to a roughly similar extent. The reason that the high-end world is shaped so much more by Wizardly activity than it is by powerful swordsmen, is because the vast majority of high level characters are spellcasters!
...
\vspace*{-8pt}
\quot{"You can only breathe fire every few seconds. I have so many tiny men that you cannot win."}
