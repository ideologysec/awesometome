...
\item{\textit{Noxious Breath (Ex):} The Drunken Master may, as a standard action, breathe in the face of a target whose face is within five feet of his. Doing so forces a Fort save, DC 10 + \half character level + Number Of Drinks Consumed In The Past Hour. If it fails, the target is nauseated for one round. If passed, the target is instead sickened for one round. If the target has Scent, it takes a penalty to his Fort Save equal to the Survival bonus granted by Scent.}
...
\ability{Liquid Power (Su):}{At level 3, the drunken master reacts to alcohol in strange ways. Choose two out of Bull's Strength, Cat's Grace, Bear's Endurance, or Cure Moderate Wounds. From now on, when the Drunken Master takes a drink, he may instead receive the benefit as if he'd drunk the respective potion.}
...
\ability{I Remember Now (Ex):}{At level 9, a drunken master gains a degree of clarity that makes him all the more terrifying, and may use certain of his abilities even while not drunk. He may use any of his Fighting Styles, his Master Fighting Style, Mean Drunk, Noxious Breath (and its improvements), Funny Drunk, and Where' He Go Now?, his bonus feats. Additionally, Loosened Up becomes Armored in Life and fully stacks with Monk levels for determining the bonus.. For Noxious Breath's DC while sober, use the Monk's Constitution modifier. For Funny Drunk's DC, use his Charisma modifier.}
